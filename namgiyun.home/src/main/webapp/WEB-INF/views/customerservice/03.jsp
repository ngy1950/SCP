  ...
  <!-- header -->
   ...
   <!-- header end -->
		...
		<table class="table table-bordered stable table-hover " >
			...
			<div>
				<span><button class="btn btn-default" type="button" onclick="location.href='/home/customerservice/01'">삭제</button></span>
				<span style="float: right;">
					<button class="btn btn-default" type="submit" onclick="location.href='/home/customerservice/01'">수정</button>
